        ...
        <div class="hero-form" id="new_partner_details_form">
            ...
            <form method="post" action="/submit-horoscope">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fullname_male"
                        onkeyup="((e) => localStorage.setItem('fullname1', e.target.value))(event)" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fullname_female"
                        onkeyup="((e) => localStorage.setItem('fullname2', e.target.value))(event)" class="form-control"
                        placeholder="Full Name">
