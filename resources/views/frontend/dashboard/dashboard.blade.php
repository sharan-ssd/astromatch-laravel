    ...
    <div class="container">
      ...
      <div class="row mt-4">
        ...
        <div class="col-md-6">
          <a
            href="matchmaker.php"
            class="btn btn-mat save-astro profilelist-btns"
            >Saved Horoscopes</a
          >
        </div>
      </div>
      ...
      <div class="recentsearch">
        <div class="row">
          <div class="col-md-8">
            <h3 class="common-heading mt-3 mb-3">
              Recent Matches            </h3>
          </div>
          <div class="col-md-4 mt-2">
            <div class="horoscope-search">
              ...
              <input
                ...
                placeholder="Search"
              />
              <a title="view all" href="matchlist.php" class="viewall-horoscope"
                >View All</a
              >
            </div>
          </div>
      ...
      <div class="row mt-4 mb-3">
          ...
          <div class="recent-matches">
            <div class="card1">
              <div class="card-body1">
                <span>K THIRUNAVUKKARASU</span> -
                <span>S SHIVANI</span>
                <span class="match-date"
                  >18/08/2025 03:23 PM                </span>
                                <span class="method-name complete-report"
                  >New Alliance Match</span
                >
                              </div>
          ...
          <div class="recent-matches">
            <div class="card1">
              <div class="card-body1">
                <span>G Udaya Prakash</span> -
                <span>S Rasegha</span>
                <span class="match-date"
                  >14/08/2025 02:54 PM                </span>
                                <span class="method-name premium-report"
                  >Existing Couple Solution</span
                >
                              </div>
            </div>
          </div>
          ...
          <div class="recent-matches">
            <div class="card1">
              <div class="card-body1">
                <span>P Dinesh Babu</span> -
                <span>S Rasegha</span>
                <span class="match-date"
                  >08/08/2025 05:53 PM                </span>
                                <span class="method-name complete-report"
                  >New Alliance Match</span
                >
                              </div>
          ...
          <div class="recent-matches">
            <div class="card1">
              <div class="card-body1">
                <span>Anand Prakash</span> -
                <span>S Rasegha</span>
                <span class="match-date"
                  >08/08/2025 05:42 PM                </span>
                                <span class="method-name complete-report"
                  >New Alliance Match</span
                >
                              </div>
          ...
          <div class="recent-matches">
            <div class="card1">
              <div class="card-body1">
                <span>Sathyanarayanan</span> -
                <span>Pavithra</span>
                <span class="match-date"
                  >08/08/2025 05:31 PM                </span>
                                <span class="method-name complete-report"
                  >New Alliance Match</span
                >
                              </div>
      ...
      <!--<h3 class="common-heading mt-3 mb-3">Transaction History</h3>
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card trans-dasboard-cards">
                    <div class="card-body">                        
                        <p class="card-text">Total reports generated : 20</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
  document.getElementById("searchInput").addEventListener("keyup", function () {
    ...
    let cards = document.querySelectorAll(".recent-matches .card1");
